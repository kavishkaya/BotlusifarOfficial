...
const SKSS = Config.WORKTYPE == 'public' ? false : true

    lusifar.addCommand({ pattern: 'video ?(.*)', fromMe: SKSS, deleteCommand: false, desc: "Download videos",  deleteCommand: false}, async (message, match) => {
        const linkk = match[1]
